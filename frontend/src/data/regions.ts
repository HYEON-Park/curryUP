...
// 시/도 명칭은 스크래퍼가 실제로 만들어내는 짧은 표기(서울, 경기 등)를 그대로 쓴다.
// 구가 있는 시(성남시, 수원시 등)는 "시명 구명" 형태로 한 단계 항목으로 평탄화해
// 수집 데이터의 "경기 성남시 분당구" 같은 3토큰 포맷과 그대로 매칭되게 한다.
export const REGIONS: RegionGroup[] = [
  ...
  {
    name: "대구",
    districts: ["중구", "동구", "서구", "남구", "북구", "수성구", "달서구", "군위군", "달성군"],
  },
  {
    name: "인천",
